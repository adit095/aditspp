...
?>
      ...
      <center>
        ...
        <h2>Edit Transaksi <?php echo $data['id_pembayaran']; ?></h2>
      <center>
      ...
      <section class="base">
        ...
        <div>
          <label>NISN</label>
          <input type="text" value="<?php echo $data['nisn']; ?>"name="kode" required="required" />
        </div>

        <div>
          <label>Tanggal</label>
            <input type="text" value="<?php echo $data['tgl_bayar']; ?>"  name="tgl" required="required">  
        </div>
        ...
        <DIV>
          <label>Tahun</label>
                  <input type="text" value="<?php echo $data['tahun_dibayar']; ?>" name="thn">
                </div>
